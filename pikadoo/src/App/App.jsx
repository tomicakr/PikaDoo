...
class App extends React.Component {
    ...
    render() {
        ...
        const NavigableLogin = withNavigation(LoginPage);
        const NavigableRegister = withNavigation(RegisterPage);
        const NavigableSinglePlayer = withNavigation(SinglePlayer);
            ...
            <Router history={history}>
                <div>
                    ...
                    <div>
                        ...
                        <Route exact path="/login" component={NavigableLogin} />
                        <Route exact path="/register" component={NavigableRegister} />
                        <Route exact path="/singleplayer" component={NavigableSinglePlayer} />
                    </div>
                </div>
            </Router>
        );
